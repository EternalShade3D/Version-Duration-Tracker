...
STRINGS = {
    "app_title": "▶ VERSION DURATION TRACKER v1.8",
...
class VersionTimeTracker(QMainWindow):
    ...
    def display_daily_view(self):
        ...
        # Set up 6-column layout for daily view
        self.result_table.setColumnCount(6)
        self.result_table.setHorizontalHeaderLabels([
            STRINGS["col_date"],
            STRINGS["col_day"],
            STRINGS["col_total_hours"],
            STRINGS["col_decimal_hours"],
        ...
        for row, date in enumerate(sorted_dates):
            ...
            decimal_hours = entry['total'].total_seconds() / 3600
            decimal_str = f"{decimal_hours:.2f}"
    ...
    def copy_selection_to_clipboard(self):
        """Copies the selected cell content(s) to clipboard — no headers"""
        ...
        cols = sorted(list(set(item.column() for item in items)))
