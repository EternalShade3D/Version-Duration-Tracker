...
STRINGS = {
    # 🧠 App identity
    "app_title": "▶ VERSION TIME TRACKER V14", # Updated to V14
...
class VersionProcessorWorker(QObject):
    ...
    def _parse_versions(self, text):
        ...
        # First pass: parse each block for version name, time string, and day of week string
        # This populates versions_temp_parsed from newest (top of input) to oldest (bottom of input)
...
class VersionTimeTracker(QMainWindow):
    ...
    def create_input_section(self):
        ...
        self.input_text.setPlaceholderText("Example:\nVersion 33\nfilename.blend\nThu 18:15\nAuthor\n\nVersion 32\nfilename.blend\nWed 18:10\nAuthor\n\nOR:\n11h until 11h46 + 11h50 to 12h26") # Reverted placeholder to English
