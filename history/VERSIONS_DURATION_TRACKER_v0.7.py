...
COLORS = {
    ...
    "font_size_title": 36,   # título destacado, mas não exagerado
...
class VersionTimeTracker(QMainWindow):
    ...
    def create_header_section(self):
        ...
        self.subtitle_label.setStyleSheet(f"color: #aaaaaa; font-size: {COLORS['font_size_subtitle']}pt;") # Updated stylesheet
    ...
    def create_result_section(self):
        ...
        self.total_label.setStyleSheet(f"""
            ...
            font-size: {COLORS['font_size_total']}pt; /* Updated stylesheet */
        """)
    ...
    def apply_dark_theme(self):
        ...
        self.setStyleSheet(f"""
            ...
            QTextEdit {{
                ...
                font-size: {COLORS['font_size_medium']}pt; /* Updated stylesheet */
            ...
            QStatusBar {{
                font-size: {COLORS['font_size_small']}pt; /* Updated stylesheet */
                color: #aaa;
            }}
    ...
    def process_data(self):
        ...
        try:
            ...
            if filename:
                ...
                self.subtitle_label.setText(f"WORKING ON: {filename.upper()}") # Uppercase subtitle
